...
def add_encoding_training_options(parser):
    ...
    group.add_argument("--scale_factor", type=float, default=1.411, help="downsampling factor for multiscale triplane pyramid")
    group.add_argument("--enable_multiscale", type=str2bool, default=True, help="enable multiscale triplane processing")
...
def add_diffusion_training_options(parser):
    ...
    group.add_argument("--diff_net_type", type=str, default="unet_small", choices=["unet_small", "unet_raw", "multiscale_unet"], help="network type")
    ...
    # 多分辨率扩散训练参数
    group.add_argument("--enable_multiscale_diffusion", type=str2bool, default=True, help="enable multiscale diffusion training")
    group.add_argument("--multiscale_training", type=str2bool, default=True, help="use multiscale training strategy")
    group.add_argument("--enable_reblurring", type=str2bool, default=True, help="enable blur/deblur operations in multiscale diffusion")
...
def add_sampling_options(parser):
    ...
    # 多分辨率采样参数
    group.add_argument("--enable_multiscale_sampling", type=str2bool, default=True, help="enable multiscale sampling")
